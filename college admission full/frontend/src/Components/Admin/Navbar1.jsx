...
function Navbar1() {
    ...
    const Menus = [
        ...
        {title:"Admission",spacing:true,icon:<AiOutlineBarChart/>,path:"/analytics"},
        {title:"Inbox",icon:<RiMessage2Line/>,path:"inbox"},
        {title:"User",icon:<GoFileMedia/>,path:"media"},
        {title:"Profile" , spacing:true,icon:<People/>,path:"/profile"},
        {title:"Setting",icon:<FiSettings />,path:"setting"},
        {title:"Logout",icon:<BiLogOut/>,path:"logout"},

    ]
  return (
    <div className='flex'>    
        <div className={`flex flex-col  bg-white rounded-xl space-y-10  h-screen ${open ? "w-64" : "w-20 "}  transition-width duration-300 relative`} 
        onMouseEnter={()=>setOpen(true)} 
        onMouseLeave={()=>setOpen(false)}>
        <div className='bg-blue-500 h-screen p-5 space-y-3'>
       ...
       <div className=' flex h-20 bg-slate-800 w-full shadow'>
            ...
            <div className='flex  justify-end w-full'>
                <div className='p-4 bg-white w-64'>
                     <i className='fa fa-user text-black rounded bg-light text-bold'></i>
                     <p>{uname}</p>
                </div>
            </div>
       </div>
        ...
        <div className='flex  grid-flow-row space-x-3 justify-center'>
            <div className='grid w-46 shadow-sm p-20  shadow-black'>Students </div>
            <div className='grid w-46 shadow-sm p-20  shadow-black'>Teachers</div>
            <div className='grid w-46 shadow-sm p-20  shadow-black'>Admissions</div>
            <div className='grid w-46 shadow-sm p-20  shadow-black'>Projects</div>
        </div>
    </div>
    </div>
