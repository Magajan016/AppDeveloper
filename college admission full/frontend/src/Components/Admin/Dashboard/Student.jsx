...
function Student() {
  return (
    <div className='w-auto m-2 h-[630px] rounded '> 
<div class="w-full m-2 h-[630px]">
    <div class="flex items-center justify-between py-4 bg-white ">
        ...
        <div class="relative">
            ...
            <input type="text" id="table-search-users" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 d" placeholder="Search for users"/>
        </div>
    </div>
