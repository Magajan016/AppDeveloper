...
function HomeNavbar() {
  return (
    <div className="">
      <div></div>
      <div className="flex space-x-44 items-center border-2 p-6  h-full bg-white  justify-center">
        ...
        <div className="flex justify-evenly  space-x-20">
          <div class="text-xl   cursor-pointer p-2">
            <button className="hover:text-blue-600 p-4 outline"> Home</button>
          </div>
          <div className="text-xl   cursor-pointer p-2">
            <button className="hover:text-blue-600 outline"> About</button>
          </div>
          <div class="text-xl  cursor-pointer p-2">
